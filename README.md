...
## 💫 About Me:
Currently pursuing a Master’s degree in Pure Mathematics with a specialization in Geometric Analysis, where I investigate the interplay between geometric structures and partial differential equations. My research focuses on advancing analytical techniques to study the Yamabe Problem, nonlinear PDEs, and their applications to Riemannian manifolds. Building on a Bachelor’s degree in Physics, which provided foundational expertise in mathematical physics and quantum field theory, I now leverage advanced tools from differential geometry, functional analysis, and geometric measure theory to address open problems in modern geometric analysis. Passionate about bridging abstract mathematical theory with profound physical intuition, I aim to contribute to cutting-edge research while exploring interdisciplinary connections. <br>

Complementing my mathematical work, I maintain a strong interest in software development and open-source collaboration. Proficient in Python for numerical simulations and symbolic computations (using libraries like NumPy and SciPy), I also develop lightweight tools to visualize geometric phenomena and streamline analytical workflows. Beyond scientific programming, I enjoy experimenting with front-end technologies (HTML/CSS, JavaScript frameworks) to design intuitive interfaces for educational or research-oriented projects. My commitment to open-source principles drives me to engage with communities that value transparency, creativity, and shared progress. <br>

Feel free to explore my repositories, which include both academic projects in geometric analysis and creative coding endeavors that merge my love for mathematics with programming. <br>
